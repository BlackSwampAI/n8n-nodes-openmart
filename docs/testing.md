...
TypeScript hook and metadata contracts cover the consolidated Company/Person identities, exact declarative routes, guarded brand search, first-page company enrichment, and one-task known-person enrichment. Brand Search emits provider fields plus `openmart_next_cursor` when returned; this is cursor visibility, not pagination support. No live call or actual n8n execution was performed for this batch.
